...
%% Inicializar celdas
Y_all = cell(1, length(theta1));
t_all = cell(1, length(theta1));
S_all = cell(1, length(theta1));  % Sensibilidades respecto a theta1
...
xlabel('Time', 'Interpreter', 'latex');
ylabel('$S_{X}(\theta_{2})$', 'Interpreter', 'latex');
set(gca, 'FontSize', 20);
...
xlabel('Time', 'Interpreter', 'latex');
ylabel('$S_{Y}(\theta_{2})$', 'Interpreter', 'latex');
set(gca, 'FontSize', 20);
...
xlabel('Time', 'Interpreter', 'latex');
ylabel('$S_{Z}(\theta_{2})$', 'Interpreter', 'latex');
set(gca, 'FontSize', 20);
